...
public class ValidationKafkaConfig {
    ...
    @Bean(name = "validationKafkaTemplate")
    public KafkaTemplate<String, String> validationKafkaTemplate() {
    ...
    private ConsumerFactory<String, String> validationConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "validation-enrichment-kafka");
    ...
    private DefaultErrorHandler validationErrorHandler() {
